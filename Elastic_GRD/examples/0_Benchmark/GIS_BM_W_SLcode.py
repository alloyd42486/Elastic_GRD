#
# Compute benchmark for GIS against SLcode from J. Austermann
#
...
# calculate dI
dI_glq = -1.0*io.get_generic_shell_field('data/GIS_nointerp_del_ice.txt',L)
...
# Load SLcode result
sl_SLcode = io.get_generic_shell_field('data/GIS_dsl_512.txt',L)

plt.plot(sl_SLcode,label = 'RSL Change (m)',ofile = fpath+'/SL_code_rsl_change.png')
plt.plot(sl-sl_SLcode,label = 'Benchmark Residual RSL (m)',clim=[-0.001,0.001],ofile = fpath+'/BM_residual_rsl_change.png')
